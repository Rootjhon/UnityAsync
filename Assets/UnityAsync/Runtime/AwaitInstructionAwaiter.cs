...
namespace UnityAsync
{
    ...
    public struct AwaitInstructionAwaiter<T> : IAwaitInstructionAwaiter, INotifyCompletion where T : IAwaitInstruction
    {
        ...
        public AwaitInstructionAwaiter(in T inst, UObject owner, FrameScheduler scheduler)
        {
            instruction = inst;
            continuation = null;
            this.owner = owner;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AwaitInstructionAwaiter<T> ConfigureAwait(UObject owner)
        {
            this.owner = owner;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AwaitInstructionAwaiter<T> ConfigureAwait(UObject owner, FrameScheduler scheduler)
        {
            this.owner = owner;
            Scheduler = scheduler;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AwaitInstructionAwaiter<T> ConfigureAwait(UObject owner, CancellationToken cancellationToken, FrameScheduler scheduler)
        {
            this.owner = owner;
            this.cancellationToken = cancellationToken;
            Scheduler = scheduler;
