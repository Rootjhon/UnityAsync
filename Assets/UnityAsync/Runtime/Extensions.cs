...
namespace UnityAsync
{
    public static class Extensions
    {
        ...
        public static AwaitInstructionAwaiter<T> ConfigureAwait<T>(this T i, UObject parent, FrameScheduler scheduler) where T : IAwaitInstruction
        ...
        /// </summary>
        /// <returns>A continuation with updated params.</returns>
        public static AwaitInstructionAwaiter<T> ConfigureAwait<T>(this T i, UObject parent) where T : IAwaitInstruction
